...
<!-- // -->                    <div class="mb-24pt mb-sm-0 mr-sm-24pt">
  ...
  <div class="form-group row pl-5">
    <label for="text" class="col-sm-1 col-form-label ">اسم المنتج</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputEmail3" placeholder="اسم المنتج">
    </div>
  </div>
  <div class="form-group row pl-5">
      <label for="disabledSelect"class="col-sm-1 col-form-label ">الفئة</label>
      <div class="col-sm-10">
      <select id="disabledSelect" class="form-control">
        <option>عصائر</option>
        <option>مشروب غازي</option>
        <option>معلبات</option>
      </select>
      </div>
      <a href="category" class="edit" title="creat" data-toggle="tooltip"><i class="mt-2 material-icons">&#xe89d;</i></a>
    </div>
  <div class="form-group row pl-5">
    <label for="text" class="col-sm-1 col-form-label">سعر</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputPassword3" placeholder="سعر">
    </div>
  </div>
  <div class="form-group row pl-5">
    <label for="text" class="col-sm-1 col-form-label">كمية</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputPassword3" placeholder="كمية">
    </div>
  </div>

  <div class="form-group row pl-5">
    <label for="exampleFormControlFile1" class="col-sm-1 col-form-label">صورة المنتج</label>
    <div class="col-sm-5  ">
  ...
  <div class="form-group row pl-5">
    <div class="col-sm-1">عرض المنتج</div>
    <div class="col-sm-10">
  ...
  <div class="form-group row pl-5" role="tablist">
    <div class="col-sm-10 ">
    <button type="button" class="btn btn-accent">اضغط</button>
    </div>
  </div>
</form>
</div>
