...
<br>
                            <p style="font-size:30px;margin-right:10px;margin-top:40px;">اضافة فئة</p>
<!-- // -->
  ...
  <div class="form-group row pl-5">
    <label for="text" class="col-sm-1 col-form-label ">اسم الفئة</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="input" placeholder="اسم الفئة">
    </div>
  </div>
